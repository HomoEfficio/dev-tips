...
ZoneId.getAvailableZoneIds()
    ...
    .forEach { (totalSeconds, zoneIds) ->
        val hours = String.format("%+03d", totalSeconds / 3_600)
        val minutes = String.format("%02d", ((abs(totalSeconds) % 3_600) / 60))
        val seconds = String.format("%02d", (((abs(totalSeconds) % 3_600) / 60) % 60))
...
UTC-09:30:30 [Pacific/Marquesas]
...
UTC-02:30:30 [America/St_Johns, Canada/Newfoundland]
...
UTC+05:30:30 [Asia/Kolkata, Asia/Colombo, Asia/Calcutta]
UTC+05:45:45 [Asia/Kathmandu, Asia/Katmandu]
...
UTC+06:30:30 [Asia/Yangon, Asia/Rangoon, Indian/Cocos]
...
UTC+09:30:30 [Australia/North, Australia/Yancowinna, Australia/Adelaide, Australia/Broken_Hill, Australia/South, Australia/Darwin]
...
UTC+10:30:30 [Australia/Lord_Howe, Australia/LHI]
...
UTC+12:45:45 [NZ-CHAT, Pacific/Chatham]
