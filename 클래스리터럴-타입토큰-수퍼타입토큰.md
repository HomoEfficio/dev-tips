...
이 글은 토비님이 https://gaming.youtube.com/watch?v=sIBL9CCr1T4 에서 방송으로 소개해주신 수퍼 타입 토큰에 대한 내용을 바탕으로 [Neal Gafter의 글](http://gafter.blogspot.kr/2006/12/super-type-tokens.html)과 Jackson에 사용되고 있는 TypeReference 클래스의 소스 코드를 참고로 작성했다.  
